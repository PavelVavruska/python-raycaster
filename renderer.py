...
class Renderer:
    ...
    @classmethod
    def draw_from_z_buffer_wall(cls, canvas, dynamic_lighting, pixel_size, window_height, x_cor_ordered_z_buffer_data):
        ...
        for screen_x, z_buffer_wall in x_cor_ordered_z_buffer_data:
            for entry in sorted(z_buffer_wall):
                ...
                if object_distance < 0.2 or not isWall:  # skip render distance is too short
                    continue
